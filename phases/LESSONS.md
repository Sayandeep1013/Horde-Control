...
| 2026-09-17 | 00 | A passing acceptance test proves nothing until it has been made to fail. The Settings check was deliberately broken twice (a layer name, then the features array) to confirm it reports the right failure and exits non-zero | Every task whose exit criterion names an acceptance test |
