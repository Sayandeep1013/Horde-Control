...
## Source of truth
- `MASTER_SDLC.md` (v0.8.6) — intent, rules, gates, Acceptance Test Matrix, Development Phase Map for Phases 0–2 (including E0.1 and E0.2), Provisional Values Register, Review Decision Log.
