...
- **Presentation:** A compact world-space panel anchored beside the Tower, never covering the Tower or the player. The battlefield stays fully visible and fully live; the player's auto-fire is disabled while the Console is open, but the Tower keeps firing.
